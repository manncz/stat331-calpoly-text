...
+ [Check-in 5.3: xxx](#checkin5-2)
:::

## Factors with `forcats`

We have been floating around the idea of *factor* data types. In this chapter, we will formally define factors and why they are needed for data visualization and analysis. We will then learn useful functions for workinig with factors in our data cleaning steps.
...
Learn more about strings in [r4ds](https://r4ds.hadley.nz/strings.html).

Learn more about regular expressions in [r4ds](https://r4ds.hadley.nz/regexps.html).
...
+ Learn more about dates and times in [r4ds](https://r4ds.hadley.nz/datetimes.html).
