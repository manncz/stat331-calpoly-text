...
1.  [Click here](https://posit.cloud/content/5172799) to access an RStudio Cloud project which we work on in groups on Day 1 of the course *(Note: if you do not have an RStudio Cloud account, you will be asked to create one)*.

2.  If you have already installed [R, RStudio, and Quarto](#checkin3-install), you can [create a new Quarto document](#intro-to-quarto), and copy the practice activity [template](https://raw.githubusercontent.com/earobinson95/stat331-calpoly/master/practice-activities/PA1-find-the-mistakes.qmd?token=GHSAT0AAAAAABYBOW2KOG463KOTCZAHO5ZMY5MV55Q) into the file *(Note: make sure your quarto file is on Source mode and not Visual mode when you copy the template)*.
