...
Join the Stat 331 Server *(link to join can be found on canvas)* to start experimenting with the interface.
...
::: column-margin
If you would like a video tutorial on downloading RStudio, here is one: <br>

::: youtube-video-container
<iframe src="https://player.vimeo.com/video/203516968?h=7fc91cd48f&amp;color=428bca" width="640" height="400" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen>
