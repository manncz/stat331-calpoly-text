...
+ Check-in 1: Syllabus Quiz

<details class="check-in">

<summary>Complete the Syllabus Quiz on Canvas.</summary>
...
+ Check-in 2: Discord Server

<details class="check-in">

<summary>Introduce yourself in the “Introductions” channel of the Discord Server.</summary>
...
Join the Stat 331 Server *(link to join can be found on canvas)*
...
+ [Check-in 3: RStudio Projects](#setting-up-your-computer)
...
+ [Check-in 4: Introduction to `R` & RStudio](#checkin4-intro-to-r)
...
#### Check-in 3: Installing `R`, RStudio, and Quarto {#checkin3-install}
...
3.  Download and install the [latest version of Quarto](https://quarto.org/#getting-started) for your operating system. Quarto is a command-line tool released by RStudio that allows Rstudio to work with python and other R specific tools in a unified way.
...
<iframe src="https://player.vimeo.com/video/203516968?h=7fc91cd48f&color=428bca" width="640" height="400" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
...
In [File Systems](#file-systems) we learned about ...

::: check-in

#### Check-in 3: RProject {#checkin3-r-project}

4. Take a screenshot of your class directory, showing the R Project and the folder organization, including a Week 1 or Practice Activity folder. Upload this screenshot to canvas.
...
::: check-in
### Check-in 4: Introduction to `R` & RStudio {#checkin4-intro-to-r .unnumbered}
...
You can access [PA1: Find the
Mistakes](https://earobinson95.github.io/stat331-calpoly/practice-activities/PA1-find-the-mistakes.html)
one of two ways:

1. [Click here](https://posit.cloud/content/5172799) to access an RStudio Cloud
project which we work on in groups on Day 1 of the course *(Note: if you do not
have an RStudio Cloud account, you will be asked to create one)*.

2. If you have already installed [R, RStudio, and Quarto](#checkin3-install),
you can [create a new Quarto document](#intro-to-quarto), and copy the practice
activity
[template](https://raw.githubusercontent.com/earobinson95/stat331-calpoly/master/practice-activities/PA1-find-the-mistakes.qmd?token=GHSAT0AAAAAABYBOW2KOG463KOTCZAHO5ZMY5MV55Q)
into the file *(Note: make sure your quarto file is on Source mode and not
Visual mode when you copy the template)*.
...
<iframe width="963" height="602" src="https://www.youtube.com/embed/pY64VvSMy5s" title="Troubleshooting in R" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
